-- Ensure complete Plano de Contas for andre@almeida.com.br
-- Idempotent: DELETE existing data + bulk INSERT full chart of accounts
-- Synthetic accounts (no "Reduzido") get sequential IDs in 9000000+ range
-- Analytical accounts use their "Reduzido" code as id
...
-- =============================================
-- 3. Delete existing plano_contas data for the user
-- =============================================
DO $$
DECLARE
  v_user_id uuid;
...
-- =============================================
-- 4. Insert full Chart of Accounts (114 accounts)
--    id: from "Reduzido" (analytical) or 9000000+ (synthetic)
