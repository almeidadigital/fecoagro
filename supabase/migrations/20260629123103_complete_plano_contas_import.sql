...
-- Supersedes previous failed migrations (20260629120000, 20260629121000)
-- Idempotent: DELETE existing + INSERT full chart of accounts
...
-- 3. Total cleanup of existing records for this user
DO $$
DECLARE
  v_user_id uuid;
BEGIN
...
-- 4. Insert complete Chart of Accounts (full fidelity from PDF)
DO $$
DECLARE
  v_user_id uuid;
BEGIN
